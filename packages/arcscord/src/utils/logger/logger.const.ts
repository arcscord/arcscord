...
export const DATE_COLOR: string = forground.white;
export const SEPARATOR_COLOR: string = forground256Color(240);

export const MAX_TITLE_LENGTH = 8;
export const MAX_PROCESS_LENGTH = 10;

export const SPACE_FILLER = " ";
export const PROCESS_NAME_COLOR: string = forground256Color(57);

export const DEBUG_KEY_COLOR: string = forground256Color(33);
export const DEBUG_VALUE_COLOR: string = forground256Color(75);
