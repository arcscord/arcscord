...
- [`@arcscord/webhooks`](/packages/webhooks): standalone typed handling for Discord Webhook Events in existing web frameworks.
...
- [`ticket_bot`](https://github.com/arcscord/arcscord/tree/main/examples/ticket_bot): a full ticket system with Prisma, i18n, modals, and a custom execution handler.
