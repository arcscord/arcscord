...
- `ticket_bot` - [source](https://github.com/arcscord/arcscord/tree/main/examples/ticket_bot) - A full ticket system with Prisma, i18n, modals, and a custom execution handler.
